var util = require('util'),
  ...
  EmailTemplate = require('./api/emailTemplate'),
  LandingPageTemplate = require('./api/landingPageTemplate'),
  Files = require('./api/files'),
  Forms = require('./api/form');
...
function Marketo(options) {
  ...
  this.emailTemplate = new EmailTemplate(this, this._connection);
  this.files = new Files(this, this._connection);
  this.forms = new Forms(this, this._connection);
  this.users = new Users(this, this._connection);
}
